...
#1019
31. <Next Permutation> 按照2413， 2431这两个例子试试就行了 （多试试几个例子就明白了）
    从右到左，发现出现一个数变小了，那就说明该数加上后面的部分可以调整了
    没有出现变小的数，都不能调整
#1021
32. 再复习 <Longest Valid Parentheses> 可以匹配的都拿掉，剩下的就是多余的，从而获得最长的
33. 再复习 <Search in Rotated Sorted Array> 中间折断的有序数列，思路是找到单调的区间，结合binary search

#1022
34. binary search 再练习怎么讲
35. binary search 再练习怎么讲
36. 数独 有效检验
37. 解决数独，dfs,复习
