 ...
 * Generated at: 2017-07-05 22:29:34 UTC
...
return;
    ...
    try {
      ...
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("<!-- form是用来收集数据的 -->\n");
      out.write("<!-- action作用：on submit, send the form-data to a file named /javabean03-3.jsp  -->\n");
      out.write("<!-- method定义了发送表单数据的方法，get:appends form data into the URL in name/value pairs -->\n");
      out.write("<!-- post: appends form data inside the body of the HTTP request. not shown in URL -->\n");
      out.write("<form action=\"login\" method=\"post\"> \n");
      out.write("<!-- 注意这里是login哦，没有.jsp，与web.xml中的 -->\n");
      out.write("<!-- <url-pattern>/login</url-pattern>对应 （自己写的）跳转了以后url会变-->\n");
      out.write("<table>\n");
      out.write("\t<tr>\n");
      out.write("\t\t<td>用户名：</td>\n");
